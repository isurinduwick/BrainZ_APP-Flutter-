...
class FishARScreen extends StatelessWidget {
  const FishARScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Fish AR Experience'),
        elevation: 0,
      ),
      body: SafeArea(
        child: Stack(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("Select a fish to view in AR"),
                  const SizedBox(height: 20),
                  Expanded(
                    child: GridView.count(
                      ...
                      children: [
                        _buildFishButton(context, "Goldfish"),
                        _buildFishButton(context, "Salmon"),
                        _buildFishButton(context, "Tuna"),
                        _buildFishButton(context, "Shark"),
                        _buildFishButton(context, "Clownfish"),
                        _buildFishButton(context, "Angelfish"),
                      ],
                    ),
                  ),
                ],
  ...
  Widget _buildFishButton(BuildContext context, String name) {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        // Show AR view when a fish is selected - exactly like predators_ar.dart
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => ARViewWidget(
                animal: animal,
                showSwimControls: true,
              ),
            ),
          );
        } else {
          // For unavailable fish, show coming soon message
